...
const ProductCard = ({ image, title, description, price }) => (
  <div className="col">
    <div className="card h-100 penguin-card-border shadow rounded">
      <img
        src={image}
        className="card-img-top penguin-card-img w-75"
        alt={title}
      />
          ...
          <div className="col-md-6 px-3">
            ...
            >
              <div className="row g-0">
                <div className="col-md-3">
                  <img
                    src={process.env.PUBLIC_URL + "./public/icon/image 14.png"}
                    className="w-50 penguin-info"
  ...
  return (
    ...
    <ProductsSection title="Man Jacket" products={manProducts} /> */}
      ...
      <div className="tabs-container">
        ...
        <div className="tabs">
          <button
            onClick={() => handleTabChange("woman")}
            className={
              selectedTab === "woman" ? "tab-button active" : "tab-button"
            }
          >
            Woman Jacket
          </button>
          <button
            onClick={() => handleTabChange("man")}
            className={
              selectedTab === "man" ? "tab-button active" : "tab-button"
            }
          >
            Man Jacket
          </button>
